...
function getFallbackTemplate(): string {
  return `<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>cpp-perf-audit Report</title>
<style>body{font-family:system-ui;background:#0f0f13;color:#e4e4ef;max-width:800px;margin:0 auto;padding:2rem}
h1{color:#06b6d4}pre{background:#1a1a24;padding:1rem;border-radius:8px;overflow-x:auto}
...
<body><h1>⚡ cpp-perf-audit</h1>
<p>Project: {{project.name}} | {{project.cppStandard}} | Score: {{summary.score}}/100</p>
